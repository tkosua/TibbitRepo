...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int FILE_SIZE_LIMIT = 1024*1024*10;  //10MB calculated
    ...
    private Uri getOutputMediaFileUri(int mediaType) {
        //check that SDcard is mounted using Environment.getExternalStorageState();
            if (isExternalStorageAvailable()) {
                ...
                if (mediaType == MEDIA_TYPE_IMAGE) {
                    ...
                    mediaFile = new File(path + "VID _" + timestamp + ".jpg");
                }
                else
                    { return null; }
            ...
            if (requestCode == PICK_PHOTO_REQUEST || requestCode == PICK_VIDEO_REQUEST) {
                ...
                if (requestCode == PICK_VIDEO_REQUEST) {
                    ...
                    try {
                        ...
                        try {
                            inputStream.close();
                        } catch (IOException e) {   /* Has been intentionally left blank */ }
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (itemId) {
            case R.id.activity_logout:
                ParseUser.logOutInBackground();     //TODO logout needs extra work
                navigateLogin ();
                break;
